...
func (h *Handler) reloadBackendComponentsFromConfig() (err error) {
	...
	serviceStarter, err := NewServiceStarter(vegaPaths, h.log.Named("service-starter"), h.svcStore, h.walletStore, h.networkStore, connectionsManager, seqInteractor, receptionChan)
	if err != nil {
